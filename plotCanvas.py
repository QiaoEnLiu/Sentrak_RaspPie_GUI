...
class plotCanvas(FigureCanvas):
    def __init__(self, parent=None, width=5, height=4, dpi=75):
        ...
        # super().__init__(fig)
        super().__init__(plt.figure(figsize=(width, height), dpi=dpi))
    ...
    def plot(self, temperature_unit, oxygen_concentration, temperature):
        ...
        self.ax.clear()
        self.ax.plot(self.x_data, self.temperature_data, label='溫度'+self.temperature_unit, color='blue')
        self.ax.plot(self.x_data, self.oxygen_concentration_data, label='氧氣濃度', color='green')
